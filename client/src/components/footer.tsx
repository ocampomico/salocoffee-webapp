          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="space-y-1">
                <div className="font-body text-xs uppercase tracking-wider">Salo</div>
          ...
          <div>
            ...
            <div className="space-y-3 text-neutral-300">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://instagram.com/salosalocoffee"
                  target="_blank"
                ...
                <a
                  href="https://facebook.com/salosalocoffee"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/10 hover:bg-coffee-primary p-3 rounded-xl transition-all duration-300 hover:scale-110"
                ...
                <a
                  href="https://twitter.com/salosalocoffee"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/10 hover:bg-coffee-primary p-3 rounded-xl transition-all duration-300 hover:scale-110"
