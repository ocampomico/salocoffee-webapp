          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
              <div className="space-y-6">
                <h3 className="text-3xl font-bold text-neutral-800 mb-6">My Coffee Journey</h3>
                ...
                <Card className="bg-coffee-light border-0 shadow-modern-lg">
                  <CardContent className="p-8">
                    <h4 className="font-bold text-coffee-dark mb-4 text-xl">My Coffee Philosophy</h4>
            ...
            {/* Business Story */}
            <div className="bg-neutral-50 rounded-3xl p-12 shadow-modern-lg">
              <h3 className="text-3xl font-bold text-gradient mb-12 text-center">
                The Brew & Go Story
              </h3>
                ...
                {storySteps.map((step) => {
                  ...
                  return (
                    <div key={step.id} className="text-center group">
                      ...
                      <h4 className="font-bold text-neutral-800 mb-4 text-xl">{step.title}</h4>
